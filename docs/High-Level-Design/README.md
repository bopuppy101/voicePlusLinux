...
| AI interpretation options | [/home/mike/git/voicePlusLinux/docs/AI-Design/bounded-intent-classification-deterministic-or-probabilistic.md](../AI-Design/bounded-intent-classification-deterministic-or-probabilistic.md) — deterministic rules, learned classification, and whether to build our own open-source model. |
...
| Visual and audio interface | [/home/mike/git/voicePlusLinux/docs/OS-Integration-Design/visual-and-audio-user-interface-options.md](../OS-Integration-Design/visual-and-audio-user-interface-options.md) — one large wall display, integrated or sofa-table audio, candidate host computer, and decision criteria. |
