...
| Visual and audio interface | [/home/mike/git/voicePlusLinux/docs/OS-Integration-Design/visual-and-audio-user-interface-options.md](../OS-Integration-Design/visual-and-audio-user-interface-options.md) — one large wall display, integrated far-field microphones, and the decision criteria. |
