...
This is the single hardware shortlist, covering both TVs and interactive displays. All are 4K research candidates, not selected or tested hardware. Prices and seller stock are snapshots checked September 19, 2026, not delivered quotes or a lowest-price guarantee. Add applicable tax, freight, mounting, and installation. Delivery to 32937 has not been verified. Mike wants current products, not obsolete models; a purchase recommendation must establish current product status and a practical purchase source.

| Candidate | Built-in speaker output | Microphones / Ubuntu voice input | Touch support | Price snapshot |
| --- | --- | --- | --- | --- |
| **Samsung QN90F, 75-inch Mini-LED TV** — [manufacturer specifications](https://valueelectronics.com/wp-content/uploads/2025/02/Samsung-QN90F_NeoQLED_Spec-Sheet_Z3.pdf) | **60 W total**, 4.2.2-channel system. | Far-field TV voice interaction advertised. Microphone count, pickup pattern, noise suppression, and range not specified in the cited sheet; **no documented microphone feed to Ubuntu found**. | **No built-in touch.** Premium TV candidate with advertised refresh rates up to 165 Hz. | Purchase price remains to be confirmed. |
| **ViewSonic ViewBoard IFP6550 Gen 5, 65 inches** — [manufacturer specifications](https://www.viewsonic.com/us/ifp6550.html) | **40 W total**: 2 × 12 W speakers + 16 W subwoofer in the US specification table. Confirm exact generation/revision. | **Built-in microphone not specified.** Manufacturer lists optional USB microphone/audio accessories; array technology, noise suppression, and Ubuntu access depend on the accessory selected. | **Yes — infrared, up to 40 points advertised.** Fingers/stylus; verify Ubuntu touch count and gestures. | **$1,999**, [Full Compass](https://www.fullcompass.com/prod/646555-viewsonic-ifp6550-gen-5-65-4k-viewboard-interactive-display-energy-star-certified). Estimated shipping 9–12 business days, subject to confirmation and possible shipping charges. |
| **BenQ Board Essential RE6504, 65 inches** — [manufacturer specifications](https://www.benq.com/en-us/education/user-manual/benq-board-interactive-displays/re04-essential-series-board/product-overview.html) | **40 W total maximum**: 2 × 20 W (max). | **No built-in microphone on RE6504.** Requires a separate microphone for Lonzo. The eight-microphone arrays on FV/FV2 variants are not features of this priced model. | **Yes — High Precision IR, up to 40 points advertised.** Fingers/stylus with USB touch connections; verify Ubuntu touch support. | **$2,113.99**, [CDW](https://www.cdw.com/product/benq-board-essential-re6504-re04-series-65-led-backlit-lcd-display-4k/8099165). Listed for ordering; delivery unconfirmed. |
| **Samsung WEFX WE75FX, 75 inches** — [manufacturer regional specifications](https://www.samsung.com/de/business/smart-signage/interactive-display/wefx-lh75wefwlgcxen/) | **32 W total**: 2 × 16 W in Samsung's German WE75FX specification; **US SKU confirmation pending**. | **Built-in microphone not specified.** No verified array, noise suppression, pickup range, or Ubuntu microphone connection. Allow for a separate microphone. | **Yes — infrared.** Up to 40 points specified with external Windows; Linux support listed, but Ubuntu touch count/features need verification. | **$2,499**, [B&H](https://www.bhphotovideo.com/c/product/1959510-REG/samsung_we75fx_wefx_75_uhd_4k.html). Retailer lists in stock. |
| **Dell P6524QT, 65 inches** — [manufacturer guide](https://www.dell.com/support/kbdoc/en-uk/000217233/dell-p6524qt-monitor-usage-and-troubleshooting-guide) | **40 W total**: 2 × 20 W rated output. | **Built-in microphone not specified in reviewed manufacturer material.** Allow for a separate Ubuntu microphone; no integrated array/noise-suppression capability established. | **Yes — up to 20-point InGlass touch**, with palm rejection. Verify Ubuntu touch support and whether features justify the higher price. | **$4,055.77**, [B&H](https://www.bhphotovideo.com/c/product/1790549-REG/dell_p6524qt_65_class_4k.html). Retailer lists in stock. A lower indexed Dell price could not be confirmed as a purchase offer. |
...
**Established baseline — Mike’s clarification:** the existing Dell computer is already running Ubuntu and driving a display. Use that working setup as the foundation. The remaining display-input compatibility question is whether the selected screen’s touch function works under Ubuntu. Screen size, readability, picture quality, and speaker/microphone features remain selection criteria; basic Ubuntu display output and control are already established.
...
**Comparison judgment:** ViewSonic and BenQ deserve the first 65-inch comparison; Samsung's 75-inch WEFX deserves a size/readability comparison. Samsung's external-computer approach fits the proposed Ubuntu host arrangement, with Ubuntu touch support remaining to be checked. Its “OS-free” marketing does not establish open-source firmware; Samsung's price file still identifies embedded Linux. [Samsung WEFX explanation](https://insights.samsung.com/2026/03/10/standardizing-interactive-displays-across-modern-learning-environments/). The Dell's higher available retail price needs a demonstrable benefit before recommending it for Mike.

Touch alone does not establish premium television picture quality. For example, the ViewSonic Gen 5 supports 4K at 60 Hz, while the QN90F TV above advertises higher refresh rates. Compare motion, contrast, glare, and close-up text as well as touch. [ViewSonic Gen 5 supported modes](https://manuals.viewsonic.com/IFP6550-5_Specifications).
...
**Integration with Mike's existing Ubuntu computer is an absolute requirement. Windows, including Windows 11, is not a host option because it is not open source.** Mike explicitly clarified this; it supersedes the earlier note considering Windows 11. The Dell already provides working Ubuntu display output and control. Check Ubuntu touch support if the selected display includes touch. Hardware may also support Windows, but its required features and setup must not depend on Windows or a proprietary assistant.
...
Use the selected display as a peripheral of the working Dell/Ubuntu setup. Confirm touch support if included. Keep Lonzo on Ubuntu and choose any microphone used by Lonzo with an audio connection to that computer. Automatic text scaling and conversation controls are VPLinuxAI development requirements, not unresolved questions about basic Ubuntu display support.
