...
All candidates below are 4K interactive displays. Prices are US advertised snapshots, not delivered quotes or a lowest-price guarantee. Add applicable tax, freight, mounting, and installation. No seller has confirmed delivery to 32937.
...
| **Samsung WAF WA65F, 65 inches** | **$2,100**, [Samsung](https://www.samsung.com/us/smart-signage/samsung-interactive-display/65-in-interactive-display-waf-sku-lh65wafwlgcxza/) | Manufacturer listing shows out of stock. Price is a comparison reference, not a confirmed order opportunity. |
| **Samsung WAF WA75F, 75 inches** | **$2,750**, [Samsung](https://www.samsung.com/us/smart-signage/samsung-interactive-display/75-in-interactive-display-waf-sku-lh75wafwlgcxza/) | Larger touch option relevant to the 15-foot viewing position; manufacturer listing shows out of stock. |
...
**Comparison judgment:** ViewSonic and BenQ deserve the first 65-inch comparison; Samsung's 75-inch WAF deserves a size/readability comparison if stock can be established. The Dell's higher available retail price needs a demonstrable benefit before recommending it for Mike.
