...
| **ViewSonic ViewBoard IFP6550 Gen 5, 65 inches** | Interactive display with built-in speakers. [ViewSonic specifications](https://www.viewsonic.com/us/ifp6550.html). | **Touch.** Verify Ubuntu operation and exact generation; sellers mix generations under the IFP6550 name. | **$1,999**, [Full Compass](https://www.fullcompass.com/prod/646555-viewsonic-ifp6550-gen-5-65-4k-viewboard-interactive-display-energy-star-certified). Gen 5 explicitly identified; estimated shipping in 9–12 business days, subject to confirmation, with possible shipping charges. |
| **BenQ Board Essential RE6504, 65 inches** | Closely priced alternative to ViewSonic. [BenQ manufacturer specifications](https://www.benq.com/en-us/education/user-manual/benq-board-interactive-displays/re04-essential-series-board/product-overview.html). | **Touch**, supporting fingers/stylus with USB touch connections. Confirm Ubuntu operation, regional hardware revision, and included warranty. | **$2,113.99**, [CDW](https://www.cdw.com/product/benq-board-essential-re6504-re04-series-65-led-backlit-lcd-display-4k/8099165). Listed for ordering; delivery unconfirmed. |
| **Samsung WEFX WE75FX, 75 inches** | Larger interactive display designed for an external computer; relevant to viewing from 15 feet. | **Touch.** Verify Ubuntu operation. Samsung's “OS-free” description does not establish open-source firmware; see notes below. | **$2,499**, [B&H](https://www.bhphotovideo.com/c/product/1959510-REG/samsung_we75fx_wefx_75_uhd_4k.html). Retailer lists in stock. |
| **Dell P6524QT, 65 inches** | Interactive monitor with USB-C and dual 20W speakers. [Dell manufacturer listing](https://www.dell.com/en-us/shop/dell-pro-65-plus-4k-touch-monitor-p6524qt/apd/210-bjzg/monitors-monitor-accessories). | **20-point touch**, with palm rejection. Verify Ubuntu operation and whether features justify the higher price. | **$4,055.77**, [B&H](https://www.bhphotovideo.com/c/product/1790549-REG/dell_p6524qt_65_class_4k.html). Retailer lists in stock. A lower indexed Dell price could not be confirmed as a purchase offer. |
